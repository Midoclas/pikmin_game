...
export default class VerticalTouchspin {
    ...
    objectElement: HTMLElement | null = null;
    ...
    getData() {
        let elem: HTMLFormElement|null = document.querySelector(objectHTMLElement.vertical_touchspin_element_container)
        if (elem) {
                ...
                for (const key in pikminMap.mapping) {
                    ...
                    if (parseHtmlElement.body.firstChild) {
                        if (pikminMap.mapping.hasOwnProperty(key)) {
                            ...
                            this.formElement?.appendChild(parseHtmlElement.body.firstChild);   
                        }
                    }
                }
