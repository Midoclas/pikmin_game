...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _GlobalEvent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GlobalEvent */ "./src/ts/GlobalEvent.ts");
...
class Context {
    ...
    setMoney(value) {
        ...
        document.dispatchEvent(_GlobalEvent__WEBPACK_IMPORTED_MODULE_0__.moneyRefresh);
    }
    addMoney(value) {
        this.money += value;
        this.save("money", this.money.toString());
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   objectHTMLElement: () => (/* binding */ objectHTMLElement),
/* harmony export */   objectLocalStorage: () => (/* binding */ objectLocalStorage),
/* harmony export */   objectRarityRate: () => (/* binding */ objectRarityRate),
/* harmony export */   objectTreasure: () => (/* binding */ objectTreasure)
/* harmony export */ });
const objectHTMLElement = {
    //Element Type
    vertical_touchspin_element_container: "form#vertical_touchspin_element_container",
    ...
    treasure_data_container: "#treasure-data",
    ...
    treasure_getting_vertical_touchspin: "#treasure_getting_vertical_touchspin",
    treasure_getting_progress_bar: "#treasure_getting_progress_bar",
    treasure_hunting_progress_bar: "#treasure_hunting_progress_bar",
    //Onion
    onion: "#onion",
    ...
    toast: "#error-toast",
    toast_message: "#error-toast-message"
};
const objectRarityRate = {
    1: 78.39, //78.39%
    2: 93.39, //15%
    3: 98.39, //5%
    4: 99.39, //1%
...
/***/ "./src/ts/ElementsType/ProgressBar.ts":
/*!********************************************!*\
  !*** ./src/ts/ElementsType/ProgressBar.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ProgressBar {
    ...
    initStorage() {
        this.timeProgressBar = _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.global.default_time_progress_bar;
...
/***/ "./src/ts/ElementsType/VerticalTouchspin.ts":
/*!**************************************************!*\
  !*** ./src/ts/ElementsType/VerticalTouchspin.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ VerticalTouchspin)
/* harmony export */ });
/* harmony import */ var _Pikmin_PikminMap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Pikmin/PikminMap */ "./src/ts/Pikmin/PikminMap.ts");
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Default */ "./src/ts/Default.ts");
...
class VerticalTouchspin {
    ...
    initEventListener() {
        var _a, _b, _c;
        (_a = document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_1__.objectHTMLElement.vertical_touchspin_element_add)) === null || _a === void 0 ? void 0 : _a.forEach((btn) => {
        ...
        (_b = document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_1__.objectHTMLElement.vertical_touchspin_element_sub)) === null || _b === void 0 ? void 0 : _b.forEach((btn) => {
            let parent = btn.parentElement;
            btn.addEventListener("click", (e) => {
                var _a, _b;
                let input = parent === null || parent === void 0 ? void 0 : parent.querySelector('input');
        ...
        (_c = document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_1__.objectHTMLElement.vertical_touchspin_element_input)) === null || _c === void 0 ? void 0 : _c.forEach((input) => {
            const inputE = input;
    ...
    getData() {
        let elem = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_1__.objectHTMLElement.vertical_touchspin_element_container);
        if (elem) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (parseHtml.body) {
                    ...
                    let pikminMap = new _Pikmin_PikminMap__WEBPACK_IMPORTED_MODULE_0__["default"]();
                    for (const key in pikminMap.mapping) {
                        ...
                        if (parseHtmlElement.body.firstChild) {
                            if (pikminMap.mapping.hasOwnProperty(key)) {
                                ...
                                this.formElement = this.objectElement.querySelector("#vertical_touchspin_element_container");
                                (_b = this.formElement) === null || _b === void 0 ? void 0 : _b.appendChild(parseHtmlElement.body.firstChild);
                            }
                        }
                    }
                }
...
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Default */ "./src/ts/Default.ts");
/* harmony import */ var _Gameplay_Treasure_Treasure__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Gameplay/Treasure/Treasure */ "./src/ts/Gameplay/Treasure/Treasure.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class Game {
    constructor(gameplay) {
        this.moneyElement = document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_1__.objectHTMLElement.global_gold_view);
        this.context = _Context__WEBPACK_IMPORTED_MODULE_0__["default"].instance;
        this.init();
        this.gameplay = gameplay;
    }
    static get instance() {
        if (!__classPrivateFieldGet(_a, _a, "f", _Game_instance)) {
            __classPrivateFieldSet(_a, _a, new _a(new _Gameplay_Treasure_Treasure__WEBPACK_IMPORTED_MODULE_2__["default"]), "f", _Game_instance);
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Idle)
/* harmony export */ });
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Default */ "./src/ts/Default.ts");
...
/* harmony import */ var _Onion_Onion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Onion/Onion */ "./src/ts/Onion/Onion.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class Idle {
    constructor() {
        ...
        this.progressBar = new _ElementsType_ProgressBar__WEBPACK_IMPORTED_MODULE_1__["default"](_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.idle_progress_bar, false);
        this.gameplayContainer = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.gameplay_container);
        this.btn = null;
        this.onion = null;
        this.init();
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _Onion_Onion__WEBPACK_IMPORTED_MODULE_2__["default"].initOnion();
            this.initEventListener();
            this.repaint();
        });
    }
    ...
    setOnion(onion) {
        ...
        this.plant();
        (_a = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.idle_pikmin_animation)) === null || _a === void 0 ? void 0 : _a.classList.add('plant', ((_b = this.onion) === null || _b === void 0 ? void 0 : _b.pikmin.id) + "_plant_animation", "mx-auto");
    }
    resetIdle() {
        this.onion = null;
        this.isHarvestable = false;
        var idleAnimation = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.idle_pikmin_animation);
            ...
            try {
                ...
                if (parseHtml.body) {
                    ...
                    if (this.gameplayContainer !== null) {
                        this.btn = this.gameplayContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.idle_harvest_btn);
                    }
                }
            }
            catch (error) {
...
/***/ "./src/ts/Gameplay/Treasure/Treasure.ts":
/*!**********************************************!*\
  !*** ./src/ts/Gameplay/Treasure/Treasure.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Default */ "./src/ts/Default.ts");
/* harmony import */ var _TreasureGetting__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TreasureGetting */ "./src/ts/Gameplay/Treasure/TreasureGetting.ts");
/* harmony import */ var _TreasureHunting__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TreasureHunting */ "./src/ts/Gameplay/Treasure/TreasureHunting.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class Treasure {
    ...
    initStorage() {
        ...
        if (treasureStoredValue !== null) {
            let treasure = Object.values(_Default__WEBPACK_IMPORTED_MODULE_0__.objectTreasure).filter(treasure => treasure.name === treasureStoredValue)[0];
            this.setTreasure(treasure);
        }
    }
    initAction() {
        if (this.treasure !== null) {
            this.action = new _TreasureGetting__WEBPACK_IMPORTED_MODULE_1__["default"](this.treasure);
        }
        else {
    ...
    initEventListener() {
        document.addEventListener("treasureFound", () => {
            if (this.action instanceof _TreasureHunting__WEBPACK_IMPORTED_MODULE_2__["default"] && this.action.isFinished()) {
                this.action.destructor();
                this.action = new _TreasureGetting__WEBPACK_IMPORTED_MODULE_1__["default"](this.action.getTreasure());
                this.renderAction();
            }
        });
...
/***/ "./src/ts/Gameplay/Treasure/TreasureGetting.ts":
/*!*****************************************************!*\
  !*** ./src/ts/Gameplay/Treasure/TreasureGetting.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TreasureGetting)
/* harmony export */ });
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Default */ "./src/ts/Default.ts");
/* harmony import */ var _ElementsType_ProgressBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../ElementsType/ProgressBar */ "./src/ts/ElementsType/ProgressBar.ts");
...
class TreasureGetting {
    constructor(treasure) {
        this.treasure = null;
        this.container = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_container);
        this.containerData = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_data_container);
        this.startExpeditionBtn = null;
        this.finish = false;
        this.validateTreasure(treasure);
        this.treasure = treasure;
        this.verticalTouchspin = new _ElementsType_VerticalTouchspin__WEBPACK_IMPORTED_MODULE_2__["default"](_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_getting_vertical_touchspin);
        this.progressBar = new _ElementsType_ProgressBar__WEBPACK_IMPORTED_MODULE_1__["default"](_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_getting_progress_bar, false);
    }
    initElementAfterRendering() {
        this.startExpeditionBtn = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_start_expedition_btn);
    ...
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var domParser = new DOMParser();
                const treasureGettingHtml = yield fetch("./src/views/gameplay/treasure/treasure_getting.html");
                const treasureGettingDataHtml = yield fetch("./src/views/gameplay/treasure/treasure_getting_data.html");
                ...
                var html = yield treasureGettingHtml.text();
                var htmlData = yield treasureGettingDataHtml.text();
                const parseHtml = domParser.parseFromString(html, "text/html");
    ...
    renderTreasureInformation() {
        ...
        let name = (_a = this.containerData) === null || _a === void 0 ? void 0 : _a.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_information_name);
        let get_time = (_b = this.containerData) === null || _b === void 0 ? void 0 : _b.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_information_get_time);
        let rarity = (_c = this.containerData) === null || _c === void 0 ? void 0 : _c.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_information_rarity);
        let reward = (_d = this.containerData) === null || _d === void 0 ? void 0 : _d.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_information_reward);
        let weight = (_e = this.containerData) === null || _e === void 0 ? void 0 : _e.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_information_weight);
        if (name) {
...
/***/ "./src/ts/Gameplay/Treasure/TreasureHunting.ts":
/*!*****************************************************!*\
  !*** ./src/ts/Gameplay/Treasure/TreasureHunting.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TreasureHunting)
/* harmony export */ });
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Default */ "./src/ts/Default.ts");
/* harmony import */ var _ElementsType_ProgressBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../ElementsType/ProgressBar */ "./src/ts/ElementsType/ProgressBar.ts");
/* harmony import */ var _GlobalEvent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../GlobalEvent */ "./src/ts/GlobalEvent.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class TreasureHunting {
    constructor() {
        ...
        this.container = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_container);
        this.containerData = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_data_container);
        this.progressBar = new _ElementsType_ProgressBar__WEBPACK_IMPORTED_MODULE_1__["default"](_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_hunting_progress_bar, false);
        this.initStorage();
    }
    save(id, value) {
        localStorage.setItem(id, value);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (_a = this.progressBar.objectElement) === null || _a === void 0 ? void 0 : _a.addEventListener("animationend", () => {
                if (this.searchingTreasure !== null) {
                    ...
                    this.finish = true;
                    document.dispatchEvent(_GlobalEvent__WEBPACK_IMPORTED_MODULE_2__.treasureFound);
                }
                else {
                    throw new Error(`No treasure found when progress bars end`);
                }
    ...
    initStorage() {
        ...
        if (searchingTreasureStoredValue !== null) {
            let treasure = Object.values(_Default__WEBPACK_IMPORTED_MODULE_0__.objectTreasure).filter(treasure => treasure.name === searchingTreasureStoredValue)[0];
            this.setTreasure(treasure);
        }
    }
    setTreasure(treasure) {
    ...
    getRandomTreasure() {
        ...
        let rarity = 1;
        Object.keys(_Default__WEBPACK_IMPORTED_MODULE_0__.objectRarityRate).map((key) => {
            if (random > _Default__WEBPACK_IMPORTED_MODULE_0__.objectRarityRate[key]) {
                rarity = parseInt(key) + 1;
            }
        });
        let treasureList = Object.values(_Default__WEBPACK_IMPORTED_MODULE_0__.objectTreasure).filter(treasure => treasure.rarity === rarity);
    ...
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.searchTreasureBtn = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_search_btn);
                this.startExpeditionBtn = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_0__.objectHTMLElement.treasure_start_expedition_btn);
                this.initEventListener();
            }
            catch (error) {
...
class LocalStorageManager {
    ...
    initGlobal() {
        localStorage.setItem("money", _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.global.money.toString());
    }
    initOnionStorage() {
        Object.keys(_Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.onion)
            .map((key) => {
            localStorage.setItem("onion_" + key, _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.onion[key].capacity.toString());
        });
    }
    initPikminStorage() {
        Object.keys(_Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.pikmin)
            .map((key) => {
            const pikminData = _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.pikmin[key];
    ...
    initElementStorage() {
        localStorage.setItem("element_progress_bar_time_progress_bar", _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.elementType.progressBar.timeProgressBar.toString());
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Onion)
/* harmony export */ });
/* harmony import */ var _Gameplay_Idle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Gameplay/Idle */ "./src/ts/Gameplay/Idle.ts");
/* harmony import */ var _Context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Context */ "./src/ts/Context.ts");
/* harmony import */ var _Pikmin_PikminMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Pikmin/PikminMap */ "./src/ts/Pikmin/PikminMap.ts");
/* harmony import */ var _GlobalEvent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../GlobalEvent */ "./src/ts/GlobalEvent.ts");
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Game */ "./src/ts/Game.ts");
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Default */ "./src/ts/Default.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class Onion {
    constructor(pikmin, position) {
        this.container = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion);
        this.capacity = 0;
        this.pikminInstanceIdle = localStorage.getItem("idle_pikmin_instance");
        this.context = _Context__WEBPACK_IMPORTED_MODULE_1__["default"].instance;
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.pikminInstanceIdle === this.pikmin.getId()) {
                if (_Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay instanceof _Gameplay_Idle__WEBPACK_IMPORTED_MODULE_0__["default"]) {
                    _Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay.setOnion(this);
                }
    ...
    initEventListener() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (_a = this.selectOnionBtn) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
                var _a;
                if (_Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay instanceof _Gameplay_Idle__WEBPACK_IMPORTED_MODULE_0__["default"]) {
                    if (_Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay.onion == null || _Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay.onion.id !== this.id) {
                        _Game__WEBPACK_IMPORTED_MODULE_4__["default"].instance.gameplay.setOnion(this);
                        document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_select_btn).forEach((nodeElem) => {
            ...
            (_b = this.upgradeAttackBtn) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
                ...
                document.dispatchEvent(_GlobalEvent__WEBPACK_IMPORTED_MODULE_3__.moneyRefresh); //tmp
            });
            ...
            (_e = this.unlockBtn) === null || _e === void 0 ? void 0 : _e.addEventListener("click", () => {
                ...
                if (nextUnlock !== null && this.context.getMoney() >= nextUnlock.unlockCost) {
                    ...
                    document.dispatchEvent(_GlobalEvent__WEBPACK_IMPORTED_MODULE_3__.moneyRefresh);
                }
            });
            document.addEventListener("moneyRefresh", () => {
                this.repaint();
            ...
            try {
                ...
                if (parseHtml.body) {
                    ...
                    if (this.selfContainer !== null) {
                        this.selectOnionBtn = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_select_btn);
                        this.upgradeAttackBtn = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_attack_upgrade_btn);
                        this.upgradeDefenseBtn = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_defense_upgrade_btn);
                        this.upgradeLifePointBtn = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_life_point_upgrade_btn);
                    }
                }
                document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_unlock).forEach(e => e.remove());
                let nextUnlock = this.pikmin.getNextUnlock();
    ...
    static sort() {
        var onions = document.querySelectorAll(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_container);
        onions.forEach((element) => {
            ...
            if (positionAttr) {
                ...
                if (position > 1) {
                    (_a = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_container + '[data-position="' + (position - 1) + '"]')) === null || _a === void 0 ? void 0 : _a.after(element);
                }
            }
        });
    }
    static initOnion() {
        return __awaiter(this, void 0, void 0, function* () {
            let pikminMap = new _Pikmin_PikminMap__WEBPACK_IMPORTED_MODULE_2__["default"]();
            for (const key in pikminMap.mapping) {
                if (pikminMap.mapping.hasOwnProperty(key)) {
    ...
    static landing() {
        ...
        onions.forEach((element) => {
            ...
            setTimeout(() => {
                var onionImgContainer = element.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_image_container);
    ...
    repaint() {
        if (this.selfContainer) {
            var nbPikmin = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_nb_pikmin);
            var attack = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_attack);
            var lifePoint = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_life_point);
            var defense = this.selfContainer.querySelector(_Default__WEBPACK_IMPORTED_MODULE_5__.objectHTMLElement.onion_defense);
            if (nbPikmin) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BluePikmin)
/* harmony export */ });
/* harmony import */ var _Pikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Pikmin */ "./src/ts/Pikmin/Pikmin.ts");
/* harmony import */ var _PurplePikmin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PurplePikmin */ "./src/ts/Pikmin/PurplePikmin.ts");


class BluePikmin extends _Pikmin__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super("BluePikmin");
        this.nextUnlock = new _PurplePikmin__WEBPACK_IMPORTED_MODULE_1__["default"]();
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Pikmin)
/* harmony export */ });
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Default */ "./src/ts/Default.ts");
...
class Pikmin {
    constructor(id) {
        ...
        this.unlockCost = _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.pikmin[this.id].static.unlock_cost;
        this.position = _Default__WEBPACK_IMPORTED_MODULE_0__.objectLocalStorage.pikmin[this.id].static.position;
        this.initStorage();
    }
    initStorage() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PikminMap)
/* harmony export */ });
/* harmony import */ var _RedPikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RedPikmin */ "./src/ts/Pikmin/RedPikmin.ts");
/* harmony import */ var _BluePikmin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BluePikmin */ "./src/ts/Pikmin/BluePikmin.ts");
/* harmony import */ var _YellowPikmin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./YellowPikmin */ "./src/ts/Pikmin/YellowPikmin.ts");
/* harmony import */ var _PurplePikmin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PurplePikmin */ "./src/ts/Pikmin/PurplePikmin.ts");
/* harmony import */ var _WhitePikmin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./WhitePikmin */ "./src/ts/Pikmin/WhitePikmin.ts");
...
class PikminMap {
    ...
    init() {
        var redPikmin = new _RedPikmin__WEBPACK_IMPORTED_MODULE_0__["default"]();
        var bluePikmin = new _BluePikmin__WEBPACK_IMPORTED_MODULE_1__["default"]();
        var yellowPikmin = new _YellowPikmin__WEBPACK_IMPORTED_MODULE_2__["default"]();
        var purplePikmin = new _PurplePikmin__WEBPACK_IMPORTED_MODULE_3__["default"]();
        var whitePikmin = new _WhitePikmin__WEBPACK_IMPORTED_MODULE_4__["default"]();
        if (!redPikmin.lock) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PurplePikmin)
/* harmony export */ });
/* harmony import */ var _Pikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Pikmin */ "./src/ts/Pikmin/Pikmin.ts");
/* harmony import */ var _WhitePikmin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WhitePikmin */ "./src/ts/Pikmin/WhitePikmin.ts");


class PurplePikmin extends _Pikmin__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super("PurplePikmin");
        this.nextUnlock = new _WhitePikmin__WEBPACK_IMPORTED_MODULE_1__["default"]();
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RedPikmin)
/* harmony export */ });
/* harmony import */ var _YellowPikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./YellowPikmin */ "./src/ts/Pikmin/YellowPikmin.ts");
/* harmony import */ var _Pikmin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Pikmin */ "./src/ts/Pikmin/Pikmin.ts");


class RedPikmin extends _Pikmin__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor() {
        super("RedPikmin");
        this.nextUnlock = new _YellowPikmin__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ WhitePikmin)
/* harmony export */ });
/* harmony import */ var _Pikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Pikmin */ "./src/ts/Pikmin/Pikmin.ts");

class WhitePikmin extends _Pikmin__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super("WhitePikmin");
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ YellowPikmin)
/* harmony export */ });
/* harmony import */ var _Pikmin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Pikmin */ "./src/ts/Pikmin/Pikmin.ts");
/* harmony import */ var _BluePikmin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BluePikmin */ "./src/ts/Pikmin/BluePikmin.ts");


class YellowPikmin extends _Pikmin__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super("YellowPikmin");
        this.nextUnlock = new _BluePikmin__WEBPACK_IMPORTED_MODULE_1__["default"]();
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Gameplay_Idle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Gameplay/Idle */ "./src/ts/Gameplay/Idle.ts");
/* harmony import */ var _LocalStorageManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LocalStorageManager */ "./src/ts/LocalStorageManager.ts");
/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Game */ "./src/ts/Game.ts");
/* harmony import */ var _Gameplay_Treasure_Treasure__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Gameplay/Treasure/Treasure */ "./src/ts/Gameplay/Treasure/Treasure.ts");
/* harmony import */ var _Default__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Default */ "./src/ts/Default.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var localStorageManager = new _LocalStorageManager__WEBPACK_IMPORTED_MODULE_1__["default"]();
init();
function init() {
    if (!isGameExist) {
        localStorageManager.initStorage();
    }
    game = _Game__WEBPACK_IMPORTED_MODULE_2__["default"].instance;
    initEventListener();
}
function initEventListener() {
    var _a, _b, _c;
    (_a = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_4__.objectHTMLElement.global_reset_btn)) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        localStorageManager.reset();
    });
    (_b = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_4__.objectHTMLElement.idle_init_btn)) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        yield game.destroyGameplay();
        game.startGameplay(new _Gameplay_Idle__WEBPACK_IMPORTED_MODULE_0__["default"]());
    }));
    (_c = document.querySelector(_Default__WEBPACK_IMPORTED_MODULE_4__.objectHTMLElement.treasure_init_btn)) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        yield game.destroyGameplay();
        game.startGameplay(new _Gameplay_Treasure_Treasure__WEBPACK_IMPORTED_MODULE_3__["default"]);
    }));
}
